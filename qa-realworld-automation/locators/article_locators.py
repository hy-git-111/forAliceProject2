...
class ArticlePage:
    ...
    articleComposeIcon = (By.CSS_SELECTOR, "i.ion-compose")
    articleGearIcon = (By.CSS_SELECTOR, "i.ion-gear-a")## ArticlePage
...
class ArticlePage:
    ...
    articlePreviewMessage = (By.CSS_SELECTOR, "div.article-preview")
    articlePopularTagsText = (By.CSS_SELECTOR, "div.sidebar p")
    articleTagList = (By.CSS_SELECTOR, "div.tag-list")
    ...
    articleEditProfileButton = (By.CSS_SELECTOR, "a.btn.btn-sm.btn-outline-secondary")
    ...
    articleFavoriteButton = (By.CSS_SELECTOR, "button.btn.btn-sm.btn-outline-primary")
