...
CRAWLING_LOCATORS = [
    ...
    ("new_post", True, (By.CSS_SELECTOR, "a[href='/editor']")),    # Home > Login > New Post
    ...
    ("profile", True, (By.CSS_SELECTOR, "a[href^='/@']"), (By.CLASS_NAME, "btn-outline-secondary")),  # Home > Login > MyPage > Edit Profile
